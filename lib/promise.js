...
/**
 * Syntactic sugar for `.then(undefined, onReject)`. Not part of Promises/A+, but sufficiently common to be included.
 *
 * Conforms to [ES6 promises](https://people.mozilla.org/~jorendorff/es6-draft.html) specification. Read for more detail how to use this method.
 *
 * ####Example:
 *
 *     var p = new Promise;
 ...
 *     p.complete(1);
 *
 * @see ES6 spec: https://people.mozilla.org/~jorendorff/es6-draft.html
 * @param {Function} [onReject]
 * @return {Promise} newPromise
 */
